	...
	function _qsJnit(){
		...
		qsHandlerImg.fancybox({
				...
				beforeShow : function(){
			        ...
			        if(Themecfg.detail.slide > 0) quickview.find(".product-image-thumbs").bxSlider({infiniteLoop: true, pager:false, minSlides: 4, maxSlides: 4, slideMargin: 10, slideWidth: Themecfg.detail.slideWidth, mode: modeSlide, controls: parseInt(Themecfg.detail.controls), pager: parseInt(Themecfg.detail.pager),});
